...
class TestAreaState(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.outdoor_config = {"name": "Outdoor Area", "indoors": False, "exit_capable": True}
    ...
    def test_has_recent_motion_true(self):
        ...
        self.assertTrue(self.area.has_recent_motion(self.current_time, within_seconds=90))
    ...
    def test_has_recent_motion_false(self):
        ...
        # Check with custom window
        self.assertTrue(self.area.has_recent_motion(self.current_time, within_seconds=200))
