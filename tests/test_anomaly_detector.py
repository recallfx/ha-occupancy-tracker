...
from custom_components.occupancy_tracker.components.anomaly_detector import AnomalyDetector
...
class TestAnomalyDetector(unittest.TestCase):
    ...
    def test_check_for_stuck_sensors(self):
        ...
        self.sensors["sensor.living_room_motion"].record_adjacent_motion.assert_called_once_with("hallway")
    ...
    def test_check_timeouts_inactivity(self):
        ...
        self.areas["bedroom"].get_inactivity_duration.return_value = 25 * 3600  # 25 hours
    ...
    def test_check_timeouts_extended_occupancy(self):
        ...
        self.areas["bedroom"].occupancy = 1
        self.areas["bedroom"].get_inactivity_duration.return_value = 13 * 3600  # 13 hours
    ...
    def test_check_timeouts_no_warning_for_duplicate(self):
        ...
        existing_warning = Warning("extended_occupancy", "test", "bedroom", None, self.current_time)
