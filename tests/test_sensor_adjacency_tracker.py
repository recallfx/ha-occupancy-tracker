import unittest
import time
from custom_components.occupancy_tracker.components.sensor_adjacency_tracker import SensorAdjacencyTracker
...
class TestSensorAdjacencyTracker(unittest.TestCase):
    ...
    def test_check_adjacent_motion_custom_timeframe(self):
        ...
        result = self.tracker.check_adjacent_motion(sensor_id, self.current_time, timeframe=60)
        self.assertTrue(result)
    ...
    def test_check_adjacent_motion_unknown_sensor(self):
        ...
        result = self.tracker.check_adjacent_motion(unknown_sensor_id, self.current_time)
        self.assertFalse(result)
    ...
    def test_check_adjacent_motion_multiple_areas(self):
        ...
        self.tracker.record_motion("motion.kitchen", self.current_time - 10)  # recent enough
