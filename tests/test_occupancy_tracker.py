...
class TestOccupancyTracker(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.config = {
            ...
            "sensors": {
                ...
                "door_sensor_1": {"type": "magnetic", "between_areas": ["living_room", "hallway"]},
            }
        }
    ...
    def test_process_unknown_sensor_event(self):
        ...
        with patch('custom_components.occupancy_tracker.occupancy_tracker.logger') as mock_logger:
    ...
    def test_process_motion_sensor_event(self):
        ...
        self.tracker._process_motion_event.assert_called_once_with('motion_sensor_1', current_time)
    ...
    def test_process_magnetic_sensor_event(self):
        ...
        # Verify internal methods were called
        self.tracker._process_magnetic_event.assert_called_once_with('door_sensor_1', True, current_time)
        self.tracker._check_for_stuck_sensors.assert_called_once()
    ...
    def test_repeated_motion_event(self):
        ...
        self.tracker._process_repeated_motion.assert_called_once_with('motion_sensor_1', current_time)
