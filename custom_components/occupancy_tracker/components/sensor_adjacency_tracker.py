...
class SensorAdjacencyTracker:
    ...
    def __init__(self):
        self.adjacency_map: Dict[str, Set[str]] = {}  # sensor_id -> set of adjacent sensor_ids
    ...
    def check_adjacent_motion(self, sensor_id: str, timestamp: float, timeframe: float = 30) -> bool:
